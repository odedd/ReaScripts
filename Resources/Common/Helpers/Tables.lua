...
function OD_IsTableEmpty(t)
    return next(t) == nil
end

function OD_TableSimpleCompare(t1, t2)
    return table.concat(t1) == table.concat(t2)
end

-- from luaForge:
-- https://web.archive.org/web/20131225070434/http://snippets.luacode.org/snippets/Deep_Comparison_of_Two_Values_3
function OD_TableDeepCompare(t1, t2, ignore_mt)
    local ty1 = type(t1)
    local ty2 = type(t2)
    ...
    for k1, v1 in pairs(t1) do
        local v2 = t2[k1]
        if v2 == nil or not OD_TableDeepCompare(v1, v2) then return false end
    end
    for k2, v2 in pairs(t2) do
        local v1 = t1[k2]
        if v1 == nil or not OD_TableDeepCompare(v1, v2) then return false end
    end
    return true
end
