...
T.HINTS = {
    ...
    DONT_SORT_BY_RATINGS = 'Do not sort by ratings.',
    SORT_BY_RATINGS = 'Sort by ratings (favorites retain their position and do not get sorted).',
    HIDE_RATINGS = 'Hide ratings.',
    UNHIDE_RATINGS = 'Unhide ratings.',
    HIDE_TAGS = 'Hide all tags.',
    UNHIDE_TAGS = 'Unhide all tags.',
