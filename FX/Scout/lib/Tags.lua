...
PB_Tags = OD_Settings:new({
    default = {
        ...
        favorites = {},
        tagInfo ={
            [1]={name='EQ', color=0x242429ff, synonyms={'Equaliser'}, order = 1, parentId=-1},
            ...
            [4]={name='Dynamics', color=0x242429ff, order = 2, parentId=-1},
            [5]={name='Gate', color=0x242429ff, parentId=4, order = 1},
            [6]={name='Instruments', color=0x242429ff, order = 3, parentId=-1},
