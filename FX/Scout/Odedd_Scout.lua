...
--   [nomain] scout54.dat
-- @changelog
--   Cmd/Ctrl+Click creates a new track with FX/FX Chain on it
--   Instrument tracks now get named by the instrument name (if "Use instrument tracks" setting is checked)
